...
def ml_loop():
    ...
    data_file_path = os.path.join(dir_path, "model_2.sav")
...
def ml_loop(side: str):
    ...
    def rl(player):
        ...
        if done: # an episode finished
            ...
            if episode_number % 100 == 0: pickle.dump(model, open('model_2.sav', 'wb'))
            reward_sum = 0
    ...
    while True:
        # 3.1. Receive the scene information sent from the game process  接收遊戲過程中發送的場景信息
